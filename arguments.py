...
class ArgParser(object):
    def __init__(self):
        ...
        parser.add_argument('--audRate', default=11000, type=int,
        ...
        parser.add_argument('--class_num_per_step', default=5, type=int,
                            help='number of classes in each incremental step')
    ...
    def add_train_arguments(self):
        ...
        parser.add_argument('--lam_mask_distl', type=float, default=1.0)
        parser.add_argument('--lam_ins_contra', type=float, default=1.0)
        parser.add_argument('--lam_cls_contra', type=float, default=1.0)

        parser.add_argument('--cross_modal_contra', action='store_true', default=False)
        parser.add_argument('--final_mask_distil', action='store_true', default=False)
        
        parser.add_argument('--use_memory', action='store_true', default=False)
        parser.add_argument('--exemplar_num_per_class', type=int, default=1)
